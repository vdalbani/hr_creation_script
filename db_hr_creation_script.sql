--Human Resources Creation schema
--Creates 6 tables then inserts data in each tables

Rem  This set is a SUBSET of tables and data in the HR/HR schema

Rem  This PART of script will drop all SEQUENCES and TABLES related to the Schema
...
Rem  NAME  "db_hr_creation_script.sql" - Drops and then Creates SIX tables for DEMO schema
...
Rem
Rem    This PART will create indexes for schema
Rem
...
Rem
Rem    This PART will create comments for the schema
Rem
